...
import { ArrowLeft, CircleAlert, ClipboardCopy, ShieldAlert, TrafficCone } from "lucide-react";
...
import {
  buildViolationReportHtml,
  emptyViolationReport,
...
function Page() {
  ...
  const setOfficer = (patch: Partial<ViolationReportData["officer"]>) =>
  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <h1 className="text-3xl font-bold tracking-tight">İhlal Raporu</h1>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          ...
          <Section title="Şüpheli Bilgisi">
            ...
            <SelectField
              ...
              options={violationGenderOptions.map((g) => ({ label: g, value: g }))}
            />
            <div className="sm:col-span-2">
              <Field
                label="Köken"
