...
export const Route = createFileRoute("/e-posta")({
  head: () => ({
    meta: [
      { title: "E-Posta Şablonu Oluşturucu — LSPD - Toolkit" },
      { name: "description", content: "LSPD - Toolkit" },
      { property: "og:title", content: "E-Posta Şablonu Oluşturucu — LSPD - Toolkit" },
...
function Page() {
  const [data, setData, clearDraft, savedAt] = useFormDraft<EmailData>("e-posta", emptyEmail);
    ...
    <AppShell>
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Button className="press" onClick={() => setOutput(buildEmailBBCode(data))}>Raporu Oluştur</Button>
          {output ? (
