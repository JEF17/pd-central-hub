...
${checkbox("Trafik", violationTypeList(data.violationType).includes("Trafik"))}<span style="color:#FFFFFF">___</span>${checkbox("Trafik Dışı", violationTypeList(data.violationType).includes("Trafik Dışı"))}<span style="color:#FFFFFF">___</span>${checkbox("Misdemeanor", violationTypeList(data.violationType).includes("Misdemeanor"))}</div></td></tr>
</tbody></table>
